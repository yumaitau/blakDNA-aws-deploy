...
- { name: DATABASE_PASSWORD, valueFrom: { secretKeyRef: { name: {{ .Values.runtimeSecret.name | quote }}, key: {{ .Values.runtimeSecret.databasePasswordKey | quote }} } } }
- { name: BLAKDNA_NOTIFICATION_SMTP_HOSTS, valueFrom: { secretKeyRef: { name: {{ .Values.runtimeSecret.name | quote }}, key: SMTP_HOST } } }
